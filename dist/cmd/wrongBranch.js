...
export const wrongBranchCommand = new Command('wrong-branch')
    ...
    try {
        ...
        // Confirm operation
        if (!options.yes) {
            const confirmed = await confirm(`Move ${pluralize(uniqueCommits, 'commit')} from '${currentBranch}' to new branch '${targetBranch}'?`, false, options);
            if (!confirmed) {
...
//# sourceMappingURL=wrongBranch.js.map